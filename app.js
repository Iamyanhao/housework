...
const I18N = {
  zh: {
    ...
    forgot_password: "忘记密码？", verification_sent: "验证邮件已发送，请查收", enter_email_first: "请先在邮箱框里输入邮箱地址", reset_email_sent: "密码重置邮件已发送，请查收",
    join_group: "加入家庭", create_group: "创建家庭",
    enter_passcode_hint: "输入 5 位数密码加入伴侣的家庭", btn_join: "加入",
    create_hint: "创建家庭，系统会生成 5 位密码，分享给你的伴侣", btn_create: "创建家庭",
    enter_group_name: "给你们的家庭起个名字（可留空）", default_group_name: "我们的家", rename_group: "修改家庭名字",
    ...
    manage_tasks: "管理家务", change_passcode: "修改密码", current_passcode: "当前密码", exit_group: "退出家庭",
    admin_console: "管理控制台（仅管理员）",
    total_groups: "总家庭数", total_users: "总用户数", total_records: "总记录数",
    view_all_groups: "查看所有家庭", view_all_users: "查看所有用户", view_all_records: "查看所有记录",
    custom_chore_title: "新增自定义家务", custom_name_ph: "家务名称", custom_pts_ph: "分数",
    cancel: "取消", save: "保存",
    already_done_by: "已由 {name} 完成", i_did: "我做的",
    err_passcode: "密码错误或家庭已满", err_admin_key: "管理员密钥错误",
    ...
    group_created: "家庭创建成功，密码：", passcode_changed: "新密码：",
    confirm_exit: "确定要退出家庭吗？", confirm_dissolve: "确定要解散该家庭吗？此操作不可撤销。",
    logged: "已记录", adjust_score: "调整积分", dissolve_group: "解散家庭",
    ...
    members_word: "人", remove_member: "移除", confirm_remove_member: "确定要把这个人从家庭移除吗？Ta 在这个家庭里的所有记录也会被一起删除。",
  ...
  ja: {
    ...
    forgot_password: "パスワードをお忘れですか？", verification_sent: "確認メールを送信しました", enter_email_first: "先にメールアドレスを入力してください", reset_email_sent: "パスワード再設定メールを送信しました",
    join_group: "家族に参加", create_group: "家族を作成",
    enter_passcode_hint: "5桁のパスコードを入力してパートナーの家族に参加", btn_join: "参加",
    create_hint: "家族を作成すると5桁のパスコードが発行されます。パートナーに共有してください", btn_create: "家族を作成",
    enter_group_name: "家族の名前を入力（空欄可）", default_group_name: "わたしたちの家", rename_group: "家族の名前を変更",
    ...
    manage_tasks: "家事を管理", change_passcode: "パスコード変更", current_passcode: "現在のパスコード", exit_group: "家族から退出",
    admin_console: "管理コンソール（管理者のみ）",
    total_groups: "総家族数", total_users: "総ユーザー数", total_records: "総記録数",
    view_all_groups: "全家族を表示", view_all_users: "全ユーザーを表示", view_all_records: "全記録を表示",
    ...
    err_passcode: "パスコードが違うか、家族が満員です", err_admin_key: "管理者キーが違います",
    ...
    group_created: "家族を作成しました。パスコード：", passcode_changed: "新しいパスコード：",
    confirm_exit: "家族から退出しますか？", confirm_dissolve: "この家族を解散しますか？元に戻せません。",
    logged: "記録しました", adjust_score: "スコアを調整", dissolve_group: "家族を解散",
    ...
    members_word: "人", remove_member: "削除", confirm_remove_member: "このメンバーを家族から削除しますか？この家族でのこの人の記録もすべて削除されます。",
  ...
  en: {
    ...
    forgot_password: "Forgot password?", verification_sent: "Verification email sent — check your inbox", enter_email_first: "Enter your email above first", reset_email_sent: "Password reset email sent — check your inbox",
    join_group: "Join Family", create_group: "Create Family",
    enter_passcode_hint: "Enter the 5-digit passcode to join your partner's family", btn_join: "Join",
    create_hint: "Create a family and get a 5-digit passcode to share with your partner", btn_create: "Create Family",
    enter_group_name: "Name your family (optional)", default_group_name: "Our Home", rename_group: "Rename family",
    ...
    manage_tasks: "Manage tasks", change_passcode: "Change passcode", current_passcode: "Current passcode", exit_group: "Leave family",
    admin_console: "Admin console (admin only)",
    total_groups: "Total families", total_users: "Total users", total_records: "Total records",
    view_all_groups: "View all families", view_all_users: "View all users", view_all_records: "View all records",
    ...
    err_passcode: "Wrong passcode or family is full", err_admin_key: "Wrong admin key",
    ...
    group_created: "Family created. Passcode: ", passcode_changed: "New passcode: ",
    confirm_exit: "Leave this family?", confirm_dissolve: "Dissolve this family? This can't be undone.",
    logged: "Logged", adjust_score: "Adjust score", dissolve_group: "Dissolve family",
    ...
    members_word: "members", remove_member: "Remove", confirm_remove_member: "Remove this person from the family? All their records in this family will also be deleted.",
...
document.getElementById("btn-email-signup")?.addEventListener("click", async () => {
  ...
  try {
    ...
    try {
      ...
      // account creation still succeeded even if the verification email failed to send
    }
  } catch (e) {
    showToast(e.code + " — " + e.message);
  }
...
document.getElementById("btn-forgot-password")?.addEventListener("click", async () => {
  const email = document.getElementById("email-input").value.trim();
  if (!email) return showToast(t("enter_email_first"));
  try {
    await sendPasswordResetEmail(auth, email);
    showToast(t("reset_email_sent"));
  } catch (e) {
    showToast(e.code + " — " + e.message);
  }
});
